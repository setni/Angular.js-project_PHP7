angular.module('routeApp').controller('mainCtrl', ['$scope', '$http', '$location', '$sce', 'Ajax', 'Upload',
...
]).controller('contactCtrl', ['$scope', '$routeParams', '$http', 'Ajax',
...
]).controller('loginCtrl', ['$scope', '$location', 'Ajax',
...
]).controller('homeCtrl', ['$scope', '$http', '$location', 'Ajax', 'Upload',
